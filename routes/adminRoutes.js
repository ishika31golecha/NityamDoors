 ...
 * @access  Private (FactoryAdmin, SuperAdmin, ProductionSupervisor)
 */
router.get('/order-overview', protect, authorize('FactoryAdmin', 'SuperAdmin', 'ProductionSupervisor'), async (req, res) => {
  try {
    const orders = await Order.find({
 ...
 * @access  Private (FactoryAdmin, SuperAdmin, ProductionSupervisor)
 */
router.get('/order-overview/:orderId/doors', protect, authorize('FactoryAdmin', 'SuperAdmin', 'ProductionSupervisor'), async (req, res) => {
  try {
    const { orderId } = req.params;
